...
//Package basic implements the routes for the basic GOPATH module
package basic
...
import (
	...
	//this is my external dependency (which is on the regular GOPATH)
...
//our external package, and the result of `GiveMeANumber`
...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	d := data{
		UUID:         u,
		Integer:      GiveMeANumber(),             //call our module level code
