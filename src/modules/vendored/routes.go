...
//Package vendored implements the routes for the vendored GOPATH module
package vendored
...
//our external package, and the result of `GiveMeACapitolLetter`
...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	d := data{
		UUID:         u,
		Letter:       GiveMeACapitalLetter(),      //call our module level code
